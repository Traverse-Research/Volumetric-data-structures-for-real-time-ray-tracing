...
\subsection{Path traced volume rendering} \label{introduction:path_traced_volume_rendering}
...
\subsection{Attribute separation} \label{introduction:attribute_separation}
