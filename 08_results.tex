...
\begin{figure}[H]
    \subfloat[The level set rendering the depth of the primary hit calculated with HDDA.]{
    ...
    \subfloat[Performance numbers between NanoVDB from \cite{NanoVDBBenchmark} and our implementation. All numbers are in milliseconds.]{
        \begin{tabularx}{\textwidth}{|c|X|X|X|X|}
            \hline
            \textbf{Method} & \textbf{Fog Volume Density Accumulation} & \textbf{Fog Volume SM Occupancy} & \textbf{Fog Volume L1} & \textbf{Level Set HDDA Primary Intersection} & \textbf{Level Set SM Occupancy}\\
            \hline
            NanoVDB & $4.971$ & $2.427$\\
            \hline
            Ours & $9.815$ & $1.092$ \\
